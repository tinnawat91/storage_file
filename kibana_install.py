...
def main(argv):
  ...
  if (not added):  
    ...
    os.system(" echo '' >> " + kibana_location + "/config/kibana.yml")
    os.system(" echo 'path.data: %s/app/data' >> " %kibana_location + kibana_location + "/config/kibana.yml")
    os.system(" echo 'logging:' >> " + kibana_location + "/config/kibana.yml")
    os.system(" echo '  appenders:' >> " + kibana_location + "/config/kibana.yml")
    os.system(" echo '    file:' >> " + kibana_location + "/config/kibana.yml")
    os.system(" echo '      type: file' >> " + kibana_location + "/config/kibana.yml")
    os.system(" echo '      fileName: %s/logs/kibana.log' >> " %kibana_location + kibana_location + "/config/kibana.yml")
    os.system(" echo '      layout:' >> " + kibana_location + "/config/kibana.yml")
    os.system(" echo '        type: pattern' >> " + kibana_location + "/config/kibana.yml")
    os.system(" echo '  root:' >> " + kibana_location + "/config/kibana.yml")
    os.system(" echo '    appenders: [default, file]' >> " + kibana_location + "/config/kibana.yml")
    os.system(" echo '' >> " + kibana_location + "/config/kibana.yml")
    ...
    os.system(" echo 'server.ssl.certificate: %s/config/certs/web.crt' >> " %kibana_location + kibana_location + "/config/kibana.yml")
    os.system(" echo 'server.ssl.key: %s/config/certs/web.key' >> " %kibana_location + kibana_location + "/config/kibana.yml")
