...
def main(argv):
  ...
  seed_hosts = '["10.206.161.4", "10.206.161.5", "10.206.161.6"]'
  ...
  if (not added):
    ...
    os.system(" echo 'xpack.security.http.ssl.client_authentication: none' >> " + elasticsearch_location + "/config/elasticsearch.yml")
